/*
 * This file contains all functions needed to create the tesselation of a sphere needed for the ballic grid.
 * It currently provides contains:
 *
...
#include "grid.h"
/*
 * All functions required for using the icosahedron grid.
 */
